    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="userForm">
          ...
          <input type="email" name="email" class="form-control mb-3" placeholder="Enter Your Email ID">
          <label>Password</label>
          <input type="text" name="password" class="form-control mb-3" placeholder="Enter Your Password">

          <div class="row mb-4">
            <div class="col-4">
              <select name="country" id="userCountrySelect" class="form-select">
                <option value="">--Country--</option>
                <?php while ($row = mysqli_fetch_assoc($country_query_user)) { ?>
                  <option value="<?= $row['id'] ?>">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST">
          ...
          <button type="submit" name="country_submit" class="btn btn-primary w-100">Submit</button>
        </form>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="stateForm">
              ...
              <select name="country" id="stateModalCountrySelect" class="form-select">
                <option value="">--Country--</option>
                <?php while ($row = mysqli_fetch_assoc($country_query_state)) { ?>
                  <option value="<?= $row['id'] ?>">
                    <?= htmlspecialchars($row['country_name']) ?>
                  </option>
                <?php } ?>
      ...
      <div class="modal-body">
        <form method="POST" id="cityForm">
              ...
              <select name="country" id="cityModalCountrySelect" class="form-select mb-3">
                <option value="">--Country--</option>
                <?php while ($row = mysqli_fetch_assoc($country_query_city)) { ?>
                  <option value="<?= $row['id'] ?>">
                    <?= htmlspecialchars($row['country_name']) ?>
                  </option>
                <?php } ?>
